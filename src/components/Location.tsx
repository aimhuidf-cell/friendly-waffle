              ...
              {displayed.length === 0 ? (
                ...
                displayed.map((pt, idx) => {
                  ...
                  >
                    ...
                    {/* Delivery — tooltip with schedule details */}
                    {visibleColumns.has("delivery") && (
                      <td className="px-3 py-1 text-center">
                        {(() => {
                          ...
                          if (!item) {
                            return <span className="inline-block text-[11px] text-foreground/80">{ed}</span>
                          }
                            ...
                            <TooltipProvider delayDuration={100}>
                              ...
                              >
                                <TooltipTrigger asChild>
                                  <button
                                    type="button"
                                    className="inline-block cursor-help text-[11px] text-foreground/80 transition-colors hover:text-primary"
                                ...
                                <TooltipContent side="top" className="max-w-[220px] text-center text-[11px] z-[9999]">
                                  ...
                                  <div className="text-[11px] text-black dark:text-white">Delivery from {item.description}</div>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          )
