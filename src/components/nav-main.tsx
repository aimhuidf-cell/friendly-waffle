            ...
            >
              <SidebarMenuItem>
                ...
                >
                  ...
                  <span className={`flex-1 text-[11px] font-medium leading-tight ${isActive ? "text-foreground" : "text-foreground/90"}`}>{item.title}</span>
                          ...
                          {item.items?.map((subItem) => {
                            ...
                            return (
                              <SidebarMenuSubItem key={subItem.title}>
                                <SidebarMenuSubButton
                                  className={`relative rounded-md px-2.5 py-2 text-[11px] transition-colors ${isActive ? "bg-sidebar-accent text-foreground" : "text-muted-foreground hover:bg-sidebar-accent/70 hover:text-foreground"}`}
                                  isActive={isActive}
                                  onClick={() => {
